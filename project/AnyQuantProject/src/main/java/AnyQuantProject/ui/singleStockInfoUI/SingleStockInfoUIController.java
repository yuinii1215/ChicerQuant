...
//    public Scene singleStockUIScene;
    ...
    public JFreeChart drawDayKLine() {
    	...
    	return  DrawKLineChart.DayKLineChart (dayKLineList,stockName,TimeType.DAY,null);
    }
    ...
    public JFreeChart drawWeekKLine() {      
    	...
    	return  DrawKLineChart.DayKLineChart (weekKLineList,stockName,TimeType.WEEK,null);
    }
    ...
    public JFreeChart drawMonthKLine() {
    	...
    	return  DrawKLineChart.DayKLineChart (monthKLineList,stockName,TimeType.WEEK,null);
